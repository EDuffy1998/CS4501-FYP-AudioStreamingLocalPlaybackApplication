...
public class TwoHundredFiftySixAudioStreamTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_hundred_fifty_six_audio_stream_test);
         ...
         */
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/cs4501-audio-streaming-app.appspot.com/o/twohundredfiftysixkbps.mp3?alt=media&token=665f7fe5-3d20-478b-b1c5-b0584121d9c7");
        mediaplayer = MediaPlayer.create(this, uri);

        mediaplayer.setLooping(true);
        mediaplayer.seekTo(0);
        mediaplayer.setVolume(0.5f,0.5f); // Setting the volume
        TotalAmountOfTime = mediaplayer.getDuration();

        // Initializing the position bar
        positionbar = findViewById(R.id.positionBar);
        // Setting the maximum of the position bar
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            // Updating the position bar as the music is being played, music bar progresses to the right from the left
            ...
            // Creating a variable containing the remaining time
    ...
    public String createTimeLabel(int time){
        ...
        return timeLabel; // Timer with remaining time presented to the user, refereshed for every second of audio playback
    }
