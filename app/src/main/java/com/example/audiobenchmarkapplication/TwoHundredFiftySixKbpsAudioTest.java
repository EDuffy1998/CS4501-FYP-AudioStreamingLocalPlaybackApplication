...
public class TwoHundredFiftySixKbpsAudioTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_hundred_fifty_six_kbps_audio_test);
         ...
         */
        mediaplayer = MediaPlayer.create(this, R.raw.twohundredfiftysixkbps);
