...
public class OneHundredTwentyEightAudioStream extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_hundred_twenty_eight_audio_stream);
         ...
         */
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/cs4501-audio-streaming-app.appspot.com/o/onehundredtwentyeightkbps.m4a?alt=media&token=bfe3accd-dec0-483e-8d74-77f99a38bcac");
        ...
        // Setting the maximum of the position bar to the audio file's total time
