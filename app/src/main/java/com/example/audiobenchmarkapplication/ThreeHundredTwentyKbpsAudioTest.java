...
public class ThreeHundredTwentyKbpsAudioTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            ...
            Raw audio file is set with the media player
         ...
         */
        mediaplayer = MediaPlayer.create(this, R.raw.threehundredtwentykbps);
