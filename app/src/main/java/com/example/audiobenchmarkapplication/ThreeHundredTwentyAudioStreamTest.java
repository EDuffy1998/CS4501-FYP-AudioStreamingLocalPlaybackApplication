...
public class ThreeHundredTwentyAudioStreamTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_hundred_twenty_audio_stream_test);
         ...
         */
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/cs4501-audio-streaming-app.appspot.com/o/threehundredtwentykbps.mp3?alt=media&token=def40550-9116-4cbb-ad6d-8604cf8daede");
