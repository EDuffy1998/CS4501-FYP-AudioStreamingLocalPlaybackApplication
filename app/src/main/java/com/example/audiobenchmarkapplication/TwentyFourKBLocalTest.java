...
public class TwentyFourKBLocalTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twenty_four_k_b_local_test);
        ...
        /*
            ...
            Mediaplayer is set to raw audio file
         ...
         */
        mediaplayer = MediaPlayer.create(this, R.raw.sixtyfourkbps);
