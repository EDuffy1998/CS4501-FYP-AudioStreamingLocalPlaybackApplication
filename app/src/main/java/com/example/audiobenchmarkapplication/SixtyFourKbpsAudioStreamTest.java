...
public class SixtyFourKbpsAudioStreamTest extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sixty_four_kbps_audio_stream_test);
         ...
         */
        Uri uri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/cs4501-audio-streaming-app.appspot.com/o/sixtyfourkbps.mp3?alt=media&token=47fa83ac-b730-4939-8af7-c3b0ceb7672d");
